 ...
 * @author 任锯东
 */
public interface easybuy_forgetDao {

	public String getEasyBuyQuestion(String eu_user_id);//根据Id获取指定用户信息(第一个问题)
	public String getEasyBuyQuestion1(String eu_user_id);//根据Id获取指定用户信息(第二个问题)
	public String getEasyBuyQuestion2(String eu_user_id);//根据Id获取指定用户信息(第三个问题)
	public String getEasyBuyAnswer(String eu_user_id, String eu_question,
			...
			String eu_answer2);//用于判断提示问题答案是否正确
	public int updateForget(easybuy_user eu);//根据问题答案修改用户密码
	public String getMobile(String eu_user_id);//根据用户名获取手机号
