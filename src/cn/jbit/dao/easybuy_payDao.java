 ...
 * @author 任锯东
 */
public interface easybuy_payDao {

	public String getEasyBuyPay(String eu_user_name,String paycardid,String paypwd);//根据eu_user_id,payid,paypwd获取指定用户信息(银行卡内金额)
