 ...
 * @author 任锯东
 */
public interface easybuy_newsBiz {

	public List<easybuy_news> getEasybuy_news(int cpage, int pageSize,String en_Title);//分页显示获取新闻
	public int getNewsCount(String en_Title);//根据新闻标题获取新闻的总数量
	public List<easybuy_news> getEasybuy_Click(int cpage, int pageSize,String en_Title);//分页显示新闻点击率排行
	public List<easybuy_news> getTen();//获取最近十条新闻 top 10
	public easybuy_news getNews(int en_id);//获取指定Id新闻
	public int addNew(easybuy_news en);//添加新闻
	public int delNew(String en_id);//根据Id删除新闻
	...
	public List<easybuy_news> getAfterNew(int cpage, int pageSize,String en_Title);//分页获取除了前十条的新闻
	public int getAfterNewsCount(String en_Title);//获取除了前十条新闻的总数量
