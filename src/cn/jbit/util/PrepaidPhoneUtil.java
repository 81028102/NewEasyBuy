...
public class PrepaidPhoneUtil {
	...
	public static final String key ="8f0a675c828f3fd2011dcf798ac3eead";//申请的接口Appkey
	public static final String openId="JH31fd4da0871070921349cb43be670116";//在个人中心查询
	...
	*//**
	...
	public static String onlineOrder(String phone,int cardnum,String orderid) throws Exception{
		...
		MD5 md5=new MD5();
		//Md5Util工具类
		String sign = md5.getkeyBeanofStr(openId+key+phone+cardnum+orderid);
	...
	*//**
	...
	public static String yuE() throws Exception{
		...
		String sign = md5.getkeyBeanofStr(openId+key+timestamp);
