		...
		<div class="shadow">
			<em class="corner lb"></em> <em class="corner rt"></em>
				...
				<ul class="steps clearfix">
					...
					<li class="finished"><em></em>${Entertheanswerretrievepassword }</li>
					<li class="last-current"><em></em>${Changethepassword }</li>
					<li class="lasts"><em></em>${Modifythesuccess }</li>
				</ul>
			<div class="manage">
				<form id="user-modify" action="<%=request.getContextPath()%>/updateforgetServlet?action=updateForget" method="post">
					<table class="form">
						<tr>
							<td class="field"></td><td class="field"></td>
							<td><input type="hidden" class="text" id="eu_answer"
								name="eu_answer" value="${requestScope.eu_answer}" /></td>
						</tr>
						<tr>
							<td class="field"></td><td class="field"></td>
							<td><input type="hidden" class="text" id="eu_answer1"
								name="eu_answer1" value="${requestScope.eu_answer1}" /></td>
						</tr>
						<tr>
							<td class="field"></td><td class="field"></td>
							<td><input type="hidden" class="text" id="eu_answer2"
								name="eu_answer2" value="${requestScope.eu_answer2}" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><label class="ui-blue"><input type="submit" class="point"
									...
									href="<%=request.getContextPath()%>/user-forgets.jsp"><input
