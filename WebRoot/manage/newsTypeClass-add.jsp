				...
				<form id="newsTypeClass-add"
					...
					<table class="form">
						<tr>
							...
							<td><input type="text" class="text" id="ent_name" name="ent_name"
								value="" placeholder="请输入分类名称" autocomplete="off" />
							<span></span></td>
						</tr>
						<tr>
							<td></td>
							<td><label class="ui-blue"><input type="submit"
									class="point" name="submit" value="添加分类" /> </label> <label class="ui-blue"><input type="reset" class="point" value="清空"/></label> <label
								class="ui-blue"><a
									href="<%=request.getContextPath()%>/NewsServlet?action=types"><input
