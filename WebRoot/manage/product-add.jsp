				...
				<form id="product-add" action="<%=request.getContextPath()%>/product_servlet?action=add" method="post"
					...
					<table class="form">
						<tr>
							...
							<td><input type="text" class="text" id="productName" name="productName" placeholder="请输入商品名称" autocomplete="off"/>
							<span></span></td>
						</tr>
						<tr>
							<td class="field">描述:</td>
							<td><input type="text" class="text" id="productdesc" name="productdesc" placeholder="请输入商品描述" autocomplete="off"/>
							<span></span></td>
						</tr>
						<tr>
									...
									<c:forEach var="one" items="${hone }">
										...
										<c:forEach var="two" items="${htwo }">
											<c:if test="${two.epc_Parent_id eq one.epc_Id }">
												<option value="${two.epc_Id }">└${two.epc_Name }</option>
											</c:if>
										</c:forEach>
									</c:forEach>
							</select>
						...
						<tr>
							...
							<td><input type="text" class="text" id="productPrice" name="productPrice" placeholder="请输入商品价格" autocomplete="off" />元
							<span></span></td>
						</tr>

						<tr>
							<td class="field">库存(<a style="color: red;">*</a>):</td>
							<td><input type="text" class="text" id="productCount" name="productCount" placeholder="请输入库存数量" autocomplete="off" onkeyup="this.value=this.value.replace(/\D/g,'')"
						...
						<tr>
							...
							<td><input type="text" class="text" id="address" name="address" placeholder="请输入原产地" autocomplete="off"/>
							<span></span></td>
						</tr>
						<tr>
							<td><input type="hidden" id="ep_Create_time" name="ep_Create_time"/>
							</td>
						</tr>
						<tr>
							<td><input type="hidden" id="ep_Sales" name="ep_Sales"/>
							</td>
						</tr>
						<tr>
							<td></td>
							<td><label class="ui-blue"><input type="submit" class="point"
									name="submit" value="添加商品" /> </label>&nbsp;<label class="ui-blue"><input type="reset" class="point" value="清空"/></label>&nbsp;<label class="ui-blue"><a
									href="<%=request.getContextPath() %>/manage/product.jsp"><input type="button" class="point"
										name="button" value="返回" />
								</a> </label></td>
						</tr>
					</table>
				</form>
