...
<%
	//做国际化
		...
		String welcome=rb.getString("welcome");	//登陆页面
		...
		String Choosethewaytochangethepassword=rb.getString("Choosethewaytochangethepassword");//问题页面
		String Throughencryptedauthenticationproblem=rb.getString("Throughencryptedauthenticationproblem");
		String Bymobilephoneverification=rb.getString("Bymobilephoneverification");
		String Thenextstep=rb.getString("Thenextstep");
		String returns=rb.getString("returns");	
		String Retrieveandmodifythepassword=rb.getString("Retrieveandmodifythepassword");
		String Enteryouruseraccount=rb.getString("Enteryouruseraccount");
		String Entertheanswerretrievepassword=rb.getString("Entertheanswerretrievepassword");
		String Changethepassword=rb.getString("Changethepassword");
		String Yourmobilephonenumber=rb.getString("Yourmobilephonenumber");
		String SMSverificationcode=rb.getString("SMSverificationcode");
		String PleaseentertheSMSverificationcode=rb.getString("PleaseentertheSMSverificationcode");			
		String EntertheSMSverificationcode=rb.getString("EntertheSMSverificationcode");			
		String passwords=rb.getString("passwords");			
		String Pleaseenterapasswordtomodify=rb.getString("Pleaseenterapasswordtomodify");			
		String Confirmpassword=rb.getString("Confirmpassword");			
		String Pleaseenterthepasswordagain=rb.getString("Pleaseenterthepasswordagain");			
		String Modify=rb.getString("Modify");			
		String congratulations=rb.getString("congratulations");			
		String Modifythesuccess=rb.getString("Modifythesuccess");			
		String Areenteringthehomepage=rb.getString("Areenteringthehomepage");	
		String answer=rb.getString("answer");	
		String answers=rb.getString("answers");	
		...
		//放到作用域中
		request.getSession().setAttribute("welcome",welcome);//登陆页面
		...
		request.getSession().setAttribute("Choosethewaytochangethepassword",Choosethewaytochangethepassword);//问题页面
		request.getSession().setAttribute("Throughencryptedauthenticationproblem",Throughencryptedauthenticationproblem);
		request.getSession().setAttribute("Bymobilephoneverification",Bymobilephoneverification);
		request.getSession().setAttribute("Thenextstep",Thenextstep);
		request.getSession().setAttribute("returns",returns);
		request.getSession().setAttribute("Retrieveandmodifythepassword",Retrieveandmodifythepassword);
		request.getSession().setAttribute("Enteryouruseraccount",Enteryouruseraccount);
		request.getSession().setAttribute("Entertheanswerretrievepassword",Entertheanswerretrievepassword);
		request.getSession().setAttribute("Changethepassword",Changethepassword);
		request.getSession().setAttribute("Yourmobilephonenumber",Yourmobilephonenumber);
		request.getSession().setAttribute("SMSverificationcode",SMSverificationcode);
		request.getSession().setAttribute("PleaseentertheSMSverificationcode",PleaseentertheSMSverificationcode);
		request.getSession().setAttribute("EntertheSMSverificationcode",EntertheSMSverificationcode);
		request.getSession().setAttribute("passwords",passwords);
		...
		request.getSession().setAttribute("Pleaseenterthepasswordagain",Pleaseenterthepasswordagain);
		request.getSession().setAttribute("Modify",Modify);
		request.getSession().setAttribute("congratulations",congratulations);
		request.getSession().setAttribute("Modifythesuccess",Modifythesuccess);
 ...
 %>
  <div id="footer">
		...
		${Beijing}ICP${card}100000${number} ${easybuy}${site}${operatepermit} ${easybuy}8${number}
	</div>
